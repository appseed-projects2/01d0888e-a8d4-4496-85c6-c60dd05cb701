...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-24 18:25`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/01d0888e-a8d4-4496-85c6-c60dd05cb701.git
$ cd 01d0888e-a8d4-4496-85c6-c60dd05cb701
```
